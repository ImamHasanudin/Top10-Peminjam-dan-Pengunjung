...
3. **10 Pengunjung Teraktif** — gabungan **jumlah peminjaman + jumlah kunjungan** terbanyak.
...
3. Tiga menu baru akan otomatis muncul sebagai item terpisah: **"10 Peminjam Tersering"**, **"10 Pengunjung Tersering"**, **"10 Pengunjung Teraktif"** — 
...
Laporan **"10 Pengunjung Teraktif"** menjumlahkan jumlah baris dari kedua tabel tersebut per anggota (`member_id` + `member_name`), lalu mengambil 10 teratas.
